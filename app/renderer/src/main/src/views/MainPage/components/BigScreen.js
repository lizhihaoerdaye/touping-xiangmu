            ...
            <div className={styles.squareInner}>
                    <div className={styles.automaticDiv}>
                        <div className={styles.rightDepend}>
                            <Button type="primary" size="large" disabled={(mainView&&mainView.winId)?false:true} loading={btnDisable} onClick={()=>{handleOpen()}}>全屏</Button>
                            <Modal
                                width="100%"
                        ...
                        <div className={styles.rightDepend}>
                            <Button disabled={(mainView&&mainView.winId)?false:true} type="primary" shape="circle" icon="more"  size="large"/>
                        </div> 
                    </div>
                </div>
            </div>  
